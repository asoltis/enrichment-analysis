...
Updated 2023-08-14 for python 3
'''
...
class OBOparser():
    ...
    def readFile(self):
        ...
        if fileAndExtension[len(fileAndExtension)-1] != "obo":
            ...
            oboFileHandle = urlopen(self.url)
            ...
            if aline == "" and typeDefPresent == False :
                ...
                if counter>0:
                    ...
                    for j in range(len(term)):
                        ...
                        if termSplitUp[0] == "namespace": # Added by Anthony
                            node.namespace = termSplitUp[1]
                        ...
                        if termSplitUp[0] == "is_a":
                            ...
                            #node.isA = values[0] # Original version from code
...
class Node():
    ...
    def __init__(self):
        ...
        self.id = ""
        self.name = ""
        self.namespace = "" # Added by Anthony
        self.definition = ""
        self.relationship = ""
        self.related_synonym = []
        self.isA = [] # changed to list from self.isA = ""
        self.synonym = []
        self.exactSynonym = ""
        self.broadSynonym = ""
        self.narrowSynonym = ""
    ...
    def getNamespace(self): # Added by Anthony
        """
